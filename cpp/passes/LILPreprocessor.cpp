...
void LILPreprocessor::processArgInstr(const std::shared_ptr<LILRootNode> & rootNode)
{
...
bool LILPreprocessor::processArgInstr(std::shared_ptr<LILNode> node)
{
    if (this->getDebug()) {
...
bool LILPreprocessor::hasCustomArg(const LILString & name) const
{
    return this->_customArgs.count(name) > 0;
}

void LILPreprocessor::setCustomArgs(std::vector<LILString> & args)
{
    ...
    for (LILString argStr : args) {
        ...
        auto name = arg.substr(2, colonPos-2);
...
std::shared_ptr<LILNode> LILPreprocessor::getCustomArg(const LILString & name)
{
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILExpression> value)
{
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILUnaryExpression> value)
{
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILStringFunction> value)
{
    bool hasChanges = false;
    std::vector<std::shared_ptr<LILNode>> resultNodes;
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILVarDecl> value)
{
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILClassDecl> value)
{
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILObjectDefinition> value)
{
    bool hasChanges = false;
    std::vector<std::shared_ptr<LILNode>> resultNodes;
    for (auto node : value->getNodes()) {
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILAssignment> value)
{
    auto val = value->getValue();
    if (val && val->isA(InstructionTypeIf)) {
        this->_nodeBuffer.emplace_back();
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILValuePath> value)
{
    bool hasChanges = false;
    std::vector<std::shared_ptr<LILNode>> resultNodes;
    for (auto node : value->getNodes()) {
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILRule> value)
{
    std::cerr << "UNIMPLEMENTED FAIL!!!!!!!!\n\n";
    return false;
}

bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILSelectorChain> value)
{
    std::cerr << "UNIMPLEMENTED FAIL!!!!!!!!\n\n";
    return false;
}

bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILSimpleSelector> value)
{
    std::cerr << "UNIMPLEMENTED FAIL!!!!!!!!\n\n";
    return false;
}

bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILFunctionDecl> value)
{
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILFunctionCall> value)
{
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILFlowControl> value)
{
    bool hasChangesArgs = false;
    std::vector<std::shared_ptr<LILNode>> resultNodesArgs;
    for (auto node : value->getArguments()) {
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILFlowControlCall> value)
{
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILInstruction> value)
{
...
bool LILPreprocessor::_processArgInstrIfInstr(std::shared_ptr<LILIfInstruction> value)
{
    auto arg = value->getArgument();
    if (arg) {
        this->_nodeBuffer.emplace_back();
...
bool LILPreprocessor::_processArgInstrSnippetInstr(std::shared_ptr<LILSnippetInstruction> value)
{
    auto arg = value->getArgument();
    if (arg) {
        this->_nodeBuffer.emplace_back();
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILValueList> value)
{
    bool hasChanges = false;
    std::vector<std::shared_ptr<LILNode>> resultNodes;
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILIndexAccessor> value)
{
    auto arg = value->getArgument();
    if (arg) {
        this->processArgInstr(arg);
...
bool LILPreprocessor::_processArgInstr(std::shared_ptr<LILConversionDecl> value)
{
    bool hasChangesBody = false;
    std::vector<std::shared_ptr<LILNode>> resultNodes;
    for (auto node : value->getBody()) {
